...
def run_test_better_draw_circles():
    ...
    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles:  See graphics window dr=3')
    print('--------------------------------------------------')
    better_draw_circles(3)
    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles:  See graphics window dr=10')
    print('--------------------------------------------------')
    better_draw_circles(10)
    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles:  See graphics window dr=20')
    print('--------------------------------------------------')
...
def better_draw_circles(dr):
    ...
    -- Constructs and draws 21 rg.Circle objects such that:
         -- Each is centered at (200, 200)
         -- They have radii:  0  dr  2*dr  3*dr  4*dr ... 20*dr, respectively.
         -- Pauses 0.05 seconds after rendering each.
    -- Waits for the user to press the mouse, then closes the window.
    """
...
def run_test_even_better_draw_circles():
    ...
    print()
    print('--------------------------------------------------')
    print('Testing  even_better_draw_circles:  See graphics window dr=3, '
          'n=41, speed=0.025')
    print('--------------------------------------------------')
    even_better_draw_circles(3,41,0.025)
    print()
    print('--------------------------------------------------')
    print('Testing  even_better_draw_circles:  See graphics window dr=10, '
          'n=21, speed=0.05')
    print('--------------------------------------------------')
    even_better_draw_circles(10,21,0.05)
    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles:  See graphics window dr=20, n=11, '
          'speed=0.01')
    print('--------------------------------------------------')
    even_better_draw_circles(20,11,0.01)


def even_better_draw_circles(dr,n,speed):
    """
    -- Constructs a window whose width and height are both 400.
    -- Constructs and draws n rg.Circle objects such that:
         -- Each is centered at (200, 200)
         -- They have radii:  0  dr  2*dr  3*dr  4*dr ... dr*(n-1),
         respectively.
         -- Pauses 'speed' seconds after rendering each.
    -- Waits for the user to press the mouse, then closes the window.
    """
